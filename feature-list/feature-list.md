...
- Adjust volume
- **Dark / light mode** — by fixed times or offset from sunrise/sunset
...
- View calendars configured in `.env`
- Add events (choose which calendar when creating)
- Different colors per user/calendar
- **Views:** weekly, 2-week, monthly
...
- **Subscribed calendars** — holidays, school, sports, etc., in addition to personal/family Google calendars
